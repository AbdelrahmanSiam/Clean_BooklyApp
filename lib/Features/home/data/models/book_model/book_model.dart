...
class BookModel extends BookEntity {
  ...
  factory BookModel.fromBookJson(Map<String, dynamic> json) => BookModel(
    ...
    volumeInfo: json['volumeInfo'] == null
        ? null
        : VolumeInfo.fromBookJson(json['volumeInfo'] as Map<String, dynamic>),
    saleInfo: json['saleInfo'] == null
        ? null
        : SaleInfo.fromBookJson(json['saleInfo'] as Map<String, dynamic>),
    accessInfo: json['accessInfo'] == null
        ? null
        : AccessInfo.fromBookJson(json['accessInfo'] as Map<String, dynamic>),
    searchInfo: json['searchInfo'] == null
        ? null
        : SearchInfo.fromBookJson(json['searchInfo'] as Map<String, dynamic>),
  );
